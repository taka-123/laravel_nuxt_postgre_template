...
| :------------ | :--------------- | :----------------------------------------------------------------------------------------------- | :-------------------------------------------------------- | :------------------------- | :--------- | :----- |
| **JsBarcode** | アクティブ開発中 | • シンプルで使いやすい API • 1D バーコードに特化 • ブラウザ/Node.js 対応 • 豊富なオプション      | **Code 128**, Code 39, EAN, UPC, ITF, MSI など            | SVG, Canvas, IMG           | MIT        | ★★★★★  |
| **bwip-js**   | アクティブ開発中 | • 非常に多くのバーコード形式に対応 • 高度なカスタマイズ性 • Node.js でのサーバーサイド生成に強み | **Code 128**, **QR コード**, Data Matrix, PDF417 など多数 | PNG (Buffer), SVG (文字列) | MIT        | ★★★★☆  |
| **qrcode**    | アクティブ開発中 | • QR コード生成に特化 • 使いやすい API • ブラウザ/Node.js 対応 • エラー訂正レベル設定可能        | **QR コード**                                             | Canvas, SVG, UTF8          | MIT        | ★★★★☆  |
