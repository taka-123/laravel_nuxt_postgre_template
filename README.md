...
このテンプレートには以下のドキュメントが含まれています：

- **docs/** - 技術詳細ドキュメント
  - [`docs/fly-setup.md`](docs/fly-setup.md) - Fly.io デプロイの詳細手順
- **git-flow.md** - 開発フロー管理ガイド（プロジェクト全体）
- **CLAUDE.md** - プロジェクト仕様書（AI開発ツール連携用）

ドキュメントディレクトリ（docs/）は開発用のため、本番デプロイには含まれません。
